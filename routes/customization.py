...
async def customization_inspiration(font: str, color: str, size: str, product_type: str, current_user: User = Depends(get_current_active_user)):
    response = get_request(f'https://customizedclothintegrated.salmonbeach-997612a6.australiaeast.azurecontainerapps.io/customizationRequests/{font}/{color}/{size}/{product_type}', {})
